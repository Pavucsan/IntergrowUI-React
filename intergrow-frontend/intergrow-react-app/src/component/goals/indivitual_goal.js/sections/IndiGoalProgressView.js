        ...
        return(
            ...
            <section>
                ...
                <div className="card-header white">
                    ...
                    {this.state.goal.is_complete === true ? <strong className="mb-0 mr-1 ml-1 green"><MDBIcon icon='check' className='pl-1 pr-1'/> </strong>:<Button className="btn btn-primary btn-sm mb-0 mr-0 float-right" color='primary' onClick={()=>{this.togglePost()}}><i className="fas fa-plus p-1"/></Button> }
                    </p>
                </div>
